  ...
  return (
    <div className="mx-auto flex w-full max-w-[90rem] flex-col gap-y-20 px-[3vw] py-[5vh]">
      <div className="space-y-8">
        ...
        <button className="flex items-center gap-x-1 rounded bg-gradient-to-r from-hyper-pink via-[#afd5ff] to-success px-4 py-2 font-dm-sans font-bold text-base-100">
