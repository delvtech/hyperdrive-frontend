    ...
    <div className="mx-auto flex w-full max-w-[90rem] flex-col gap-y-20 px-[3vw] py-[5vh]">
      <div className="space-y-8">
        <div>
          ...
          <h5 className="font-dm-sans max-w-2xl text-h6 font-medium leading-h6 text-neutral-content sm:text-h5 sm:leading-h5">
        ...
        <button className="font-dm-sans flex items-center gap-x-1 rounded bg-gradient-to-r from-primary via-[#afd5ff] to-success px-4 py-2 font-bold text-base-100">
