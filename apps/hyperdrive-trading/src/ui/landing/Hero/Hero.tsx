  ...
  return (
    <div className="my-4 max-w-4xl">
      ...
      >
        ...
        to the yield source with a <strong>Short</strong>, or provide liquidity
        to gain exposure to the yield source <strong>and</strong> Hyperdrive
        trading fees at the same time.
      </h5>
    </div>
  );
}
