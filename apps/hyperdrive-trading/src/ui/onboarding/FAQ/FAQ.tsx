        ...
        {selectedFAQKey === "faq1" && (
          <div>
            ...
            <span>
              ...
              rate decreases. Conversely, closing longs has the immediate impact
        ...
        {selectedFAQKey === "faq2" && (
          <div>
            ...
            <span>
              ...
              paying an amount equivalent to the hy[Token]&rsquo;s discount
              (i.e., the fixed rate applied to the position size) upfront, while
              accruing the variable interest (APY) on the full size of the
              position being shorted for the duration it&rsquo;s held. <br />
              <br />
        ...
        {selectedFAQKey === "faq3" && (
          <div>
            ...
            <span>
              ...
              and closed by traders. <br /> - Variable rate on their idle
              capital being deployed to the underlying yield source. <br /> -
              Profit (or loss) resulting from taking the other side of traders’
              positions.
              <br />
        ...
        {selectedFAQKey === "faq4" && (
          <div>
            ...
            <span>
              ...
              initially expected rate of return, since their exit value depends
              on market activity. <br />
              <br />
              ...
              pending withdrawals that still share the same benefits of regular
              LP capital. Learn more in the{" "}
              <a
