  ...
  return (
    <Link
      ...
      className={classNames(
        "grid auto-cols-fr grid-flow-col text-sm transition-all last:rounded-b-lg odd:bg-base-100 hover:bg-base-300 md:text-h6 [&>*]:overflow-hidden [&>*]:text-ellipsis [&>*]:p-4",
        className,
      )}
    >
      {children}
