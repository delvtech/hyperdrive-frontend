...
if [ -n "$verification_code" ]; then
  echo "Saving verification code to src/public/.well-known/walletconnect.txt"
  mkdir -p src/public/.well-known
  echo "$verification_code" >src/public/.well-known/walletconnect.txt
else
