...
module.exports = {
  ...
  theme: {
    ...
    dropShadow: {
      glow: [
        "0 0px 5px rgba(0, 150, 255, 0.3)", // Bluish neon outer glow
        "0 0px 10px rgba(0, 150, 255, 0.2)", // Diffused bluish neon
        "0 0px 30px rgba(255, 255, 255, 0.4)", // Intense white inner glow
        // "0 0px 50px rgba(255, 255, 255, 0.6)", // Softer white mid glow
      ],
    },
    fontFamily: {
