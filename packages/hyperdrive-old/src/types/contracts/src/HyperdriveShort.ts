...
export interface HyperdriveShortInterface extends utils.Interface {
  functions: {
...
export interface HyperdriveShort extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HyperdriveShortInterface;
