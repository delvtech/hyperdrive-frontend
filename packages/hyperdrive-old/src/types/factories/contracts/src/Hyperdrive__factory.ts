...
export class Hyperdrive__factory {
  static readonly abi = _abi;
  static createInterface(): HyperdriveInterface {
    return new utils.Interface(_abi) as HyperdriveInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Hyperdrive {
    return new Contract(address, _abi, signerOrProvider) as Hyperdrive;
  }
}
