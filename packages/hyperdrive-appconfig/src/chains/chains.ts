...
export const rewardsMainnetForkChainConfig = {
  id: rewardsMainnetFork.id,
  name: "RewardsMainnetFork",
  isTestnet: true,
  dailyAverageBlocks: mainnetChainConfig.dailyAverageBlocks,
  blockExplorerName: "Etherscan",
  blockExplorerUrl: "https://etherscan.io",
  earliestBlock: 20180617n, // The first pool to be deployed, as it pre-dates the registry
  iconUrl:
...
export const chains: Record<ChainId, ChainConfig> = {
  ...
  [rewardsMainnetFork.id]: rewardsMainnetForkChainConfig,
  [gnosisFork.id]: {
    id: gnosisFork.id,
    name: "Gnosis Fork",
    isTestnet: true,
