...
export const appConfig: AppConfig = {
  hyperdrives: [
    ...
    },
    {
      ...
      initializationBlock: 20858524n,
      initializationTimestamp: 1728506395n,
      decimals: 18,
      yieldSource: "stkWell",
      depositOptions: {
        isBaseTokenDepositEnabled: true,
    ...
    },
    {
      chainId: 8453,
      kind: "ERC4626Hyperdrive",
      address: "0x48A387267462e8134deA1e4Bd8051aEa4D3ACB6d",
      version: "v1.0.20",
      name: "182d Moonwell Flagship USDC",
      initializationBlock: 21162476n,
      initializationTimestamp: 1729114299n,
      decimals: 6,
      yieldSource: "mwUsdc",
      depositOptions: {
        isBaseTokenDepositEnabled: true,
      ...
      poolConfig: {
        ...
        linkerCodeHash:
          "0xc61ed97577e39d3e28f33c3968d297197384559811e34fccbe7dbf860d37bfd8",
        initialVaultSharePrice: 1004019n,
        minimumShareReserves: 1000000000000000n,
        minimumTransactionAmount: 1000000000000000n,
        circuitBreakerDelta: 75000000000000000n,
        positionDuration: 15724800n,
    ...
    },
    {
      chainId: 8453,
      kind: "ERC4626Hyperdrive",
      address: "0xC08Ab5F58Fbc473D1D914913dAC1F1508AcFad27",
      version: "v1.0.20",
      name: "182d Moonwell Flagship EURC",
      initializationBlock: 21162449n,
      initializationTimestamp: 1729114245n,
      decimals: 6,
      yieldSource: "mwEurc",
      depositOptions: {
        isBaseTokenDepositEnabled: true,
      ...
      poolConfig: {
        ...
        linkerCodeHash:
          "0xc61ed97577e39d3e28f33c3968d297197384559811e34fccbe7dbf860d37bfd8",
        initialVaultSharePrice: 1000737n,
        minimumShareReserves: 1000000000000000n,
        minimumTransactionAmount: 1000000000000000n,
        circuitBreakerDelta: 75000000000000000n,
        positionDuration: 15724800n,
    ...
    },
    {
      chainId: 8453,
      kind: "ERC4626Hyperdrive",
      address: "0xCAa21b8f3A499094216E3fd6224F43557923890a",
      version: "v1.0.20",
      name: "30d Numun Staked nARS",
      initializationBlock: 21162434n,
      initializationTimestamp: 1729114215n,
      decimals: 18,
      yieldSource: "snars",
      depositOptions: {
        isBaseTokenDepositEnabled: true,
      ...
      poolConfig: {
        ...
        linkerCodeHash:
          "0xc61ed97577e39d3e28f33c3968d297197384559811e34fccbe7dbf860d37bfd8",
        initialVaultSharePrice: 1120928268281831985n,
        minimumShareReserves: 1000000000000000n,
        minimumTransactionAmount: 1000000000000000n,
        circuitBreakerDelta: 75000000000000000n,
        positionDuration: 2592000n,
