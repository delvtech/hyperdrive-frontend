...
import type {
  HyperdriveBase,
  HyperdriveBaseInterface,
} from "../../../contracts/src/HyperdriveBase";
...
export class HyperdriveBase__factory {
  static readonly abi = _abi;
  static createInterface(): HyperdriveBaseInterface {
    return new utils.Interface(_abi) as HyperdriveBaseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HyperdriveBase {
    return new Contract(address, _abi, signerOrProvider) as HyperdriveBase;
  }
}
