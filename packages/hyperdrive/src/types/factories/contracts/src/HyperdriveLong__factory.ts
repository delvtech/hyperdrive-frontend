...
import type {
  HyperdriveLong,
  HyperdriveLongInterface,
} from "../../../contracts/src/HyperdriveLong";
...
export class HyperdriveLong__factory {
  static readonly abi = _abi;
  static createInterface(): HyperdriveLongInterface {
    return new utils.Interface(_abi) as HyperdriveLongInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HyperdriveLong {
    return new Contract(address, _abi, signerOrProvider) as HyperdriveLong;
  }
}
