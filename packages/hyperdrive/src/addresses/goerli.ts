// See: https://github.com/delv-tech/hyperdrive/blob/main/addresses.json
export const HyperdriveGoerliAddresses = {
  ...
  // https://github.com/delv-tech/hyperdrive/blob/main/contracts/src/actions/AaveFixedBorrow.sol
