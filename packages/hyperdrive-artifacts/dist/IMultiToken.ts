export const IMultiToken = {
  ...
  metadata: {
    ...
    settings: {
      ...
      compilationTarget: {
        "contracts/src/interfaces/IMultiToken.sol": "IMultiToken",
      },
      libraries: {},
    },
    sources: {
  ...
  ast: {
    ...
    nodes: [
      ...
      },
      {
        ...
        linearizedBaseContracts: [7467, 7475, 7657, 7545],
        name: "IMultiToken",
        nameLocation: "291:11:26",
        scope: 7468,
        usedErrors: [],
      },
    ],
