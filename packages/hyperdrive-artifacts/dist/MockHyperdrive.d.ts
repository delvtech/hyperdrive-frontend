export declare const MockHyperdrive: {
    abi: readonly [{
    ...
    methodIdentifiers: {
        ...
        readonly "calculateOpenLong(uint256,uint256)": "9bd33498";
        ...
        readonly "updateLiquidity(int256)": "8120a3e2";
    };
};
//# sourceMappingURL=MockHyperdrive.d.ts.map