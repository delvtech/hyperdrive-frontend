export declare const IAaveL2HyperdriveDeployerCoordinator: {
    abi: readonly [{
    ...
    bytecode: `0x${string}`;
    methodIdentifiers: {
        readonly "convertToBase(address,address,uint256)": "ce34a8c3";
        readonly "convertToShares(address,address,uint256)": "0550e6e4";
...
//# sourceMappingURL=IAaveL2HyperdriveDeployerCoordinator.d.ts.map