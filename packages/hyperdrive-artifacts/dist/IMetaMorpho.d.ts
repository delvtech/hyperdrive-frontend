export declare const IMetaMorpho: {
    abi: readonly [{
    ...
    methodIdentifiers: {
        ...
        readonly "setFee(uint256)": "69fe0e2d";
        ...
        readonly "withdrawQueue(uint256)": "62518ddf";
        readonly "withdrawQueueLength()": "33f91ebb";
    };
};
//# sourceMappingURL=IMetaMorpho.d.ts.map