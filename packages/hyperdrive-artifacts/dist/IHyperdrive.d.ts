export declare const IHyperdrive: {
    ...
    readonly ast: {
        ...
        readonly nodes: readonly [{
            ...
            readonly linearizedBaseContracts: readonly [10506, 11484, 11624, 10695, 11575, 11357, 11697, 11037, 11609];
