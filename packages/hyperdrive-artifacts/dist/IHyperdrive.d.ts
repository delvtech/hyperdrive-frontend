export declare const IHyperdrive: {
    ...
    readonly ast: {
        ...
        readonly nodes: readonly [{
            ...
            readonly linearizedBaseContracts: readonly [11028, 11992, 12132, 11217, 12083, 11865, 12205, 11551, 12117];
