    ...
    output: {
      ...
      devdoc: {
        ...
        methods: {
          ...
          "getPoolConfig()": {
            details:
              "These parameters are immutable, so this should only need to be      called once.",
            returns: {
          ...
          "query(uint256)": {
            details:
              "Any integrations should assert the returned value is not equal to the QueryOutOfRange() selector",
            params: {
      ...
      userdoc: {
        ...
        methods: {
          ...
          "load(uint256[])": {
            notice:
              "Allows plugin data libs to provide getters or other complex         logic instead of the main.",
          },
          "name(uint256)": {
          ...
          "query(uint256)": {
            notice:
              "Returns the average price between the last recorded timestamp looking a user determined         time into the past",
          },
          "symbol(uint256)": {
  ...
  ast: {
    ...
    nodes: [
      ...
      },
      {
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      ...
                      nameLocations: ["1081:11:3", "1093:10:3"],
                      nodeType: "IdentifierPath",
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      ...
                      nameLocations: ["1816:11:3", "1828:10:3"],
                      nodeType: "IdentifierPath",
                        ...
                        arguments: [
                          {
                            ...
                            expression: {
                              ...
                              typeDescriptions: {
                                typeIdentifier:
                                  "t_type$_t_struct$_PoolConfig_$6924_storage_ptr_$",
                                typeString:
                                  "type(struct IHyperdrive.PoolConfig storage pointer)",
                              },
                            },
                            id: 1422,
                            isConstant: false,
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      id: 1395,
                      name: "IHyperdrive.PoolConfig",
                      nameLocations: ["2189:11:3", "2201:10:3"],
                      nodeType: "IdentifierPath",
                      referencedDeclaration: 6924,
                      src: "2189:22:3",
                    },
                  ...
                  initialValue: {
                    ...
                    rightExpression: {
                      expression: {
                        ...
                        typeDescriptions: {
                          typeIdentifier:
                            "t_struct$_WithdrawPool_$6875_storage",
                          typeString:
                            "struct IHyperdrive.WithdrawPool storage ref",
                        },
                      },
                      id: 1451,
                      isConstant: false,
                          ...
                          arguments: [
                            {
                              ...
                              expression: {
                                ...
                                typeDescriptions: {
                                  typeIdentifier:
                                    "t_function_internal_view$_t_uint256_$returns$_t_struct$_PresentValueParams_$10414_memory_ptr_$",
                                  typeString:
                                    "function (uint256) view returns (struct HyperdriveMath.PresentValueParams memory)",
                                },
                              },
                              id: 1463,
                              isConstant: false,
                ...
                },
                {
                  ...
                  declarations: [
                    {
                      ...
                      typeName: {
                        ...
                        pathNode: {
                          ...
                          nameLocations: ["3713:11:3", "3725:8:3"],
                          nodeType: "IdentifierPath",
                  ...
                  initialValue: {
                    ...
                    expression: {
                      ...
                      typeDescriptions: {
                        typeIdentifier:
                          "t_type$_t_struct$_PoolInfo_$6964_storage_ptr_$",
                        typeString:
                          "type(struct IHyperdrive.PoolInfo storage pointer)",
                      },
                    },
                    id: 1509,
                    isConstant: false,
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      id: 1430,
                      name: "IHyperdrive.PoolInfo",
                      nameLocations: ["3248:11:3", "3260:8:3"],
                      nodeType: "IdentifierPath",
                      referencedDeclaration: 6964,
                      src: "3248:20:3",
                    },
                        ...
                        arguments: [
                          {
                            ...
                            expression: {
                              ...
                              typeDescriptions: {
                                typeIdentifier:
                                  "t_type$_t_struct$_WithdrawPool_$6875_storage_ptr_$",
                                typeString:
                                  "type(struct IHyperdrive.WithdrawPool storage pointer)",
                              },
                            },
                            id: 1534,
                            isConstant: false,
                            ...
                            kind: "structConstructorCall",
                            lValueRequested: false,
                            nameLocations: ["4885:15:3", "4953:8:3"],
                            names: ["readyToWithdraw", "proceeds"],
                            nodeType: "FunctionCall",
                            src: "4838:166:3",
                            tryCall: false,
                            typeDescriptions: {
                              typeIdentifier:
                                "t_struct$_WithdrawPool_$6875_memory_ptr",
                              typeString:
                                "struct IHyperdrive.WithdrawPool memory",
                            },
                          },
                        ],
                        expression: {
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      ...
                      nameLocations: ["4742:11:3", "4754:12:3"],
                      nodeType: "IdentifierPath",
                      referencedDeclaration: 6875,
                      src: "4742:24:3",
                    },
                    ...
                    typeDescriptions: {
                      typeIdentifier:
                        "t_struct$_WithdrawPool_$6875_storage_ptr",
                      typeString: "struct IHyperdrive.WithdrawPool",
                    },
                  },
                  visibility: "internal",
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    pathNode: {
                      ...
                      nameLocations: ["5397:11:3", "5409:11:3"],
                      nodeType: "IdentifierPath",
              ...
              statements: [
                {
                  ...
                  initialValue: {
                    arguments: [
                      {
                        expression: {
                          ...
                          typeDescriptions: {
                            typeIdentifier:
                              "t_array$_t_uint256_$dyn_calldata_ptr",
                    ...
                    expression: {
                      ...
                      typeDescriptions: {
                        typeIdentifier:
                          "t_function_objectcreation_pure$_t_uint256_$returns$_t_array$_t_bytes32_$dyn_memory_ptr_$",
                        typeString:
                          "function (uint256) pure returns (bytes32[] memory)",
                      },
                      typeName: {
                        baseType: {
                          id: 1582,
                            ...
                            typeName: {
                              ...
                              typeDescriptions: {
                                typeIdentifier:
                                  "t_struct$_OracleData_$4609_storage_ptr",
                                typeString:
                                  "struct HyperdriveStorage.OracleData",
                              },
                            },
                            visibility: "internal",
                          },
                          ...
                          statements: [
                            {
                              expression: {
                                ...
                                leftHandSide: {
                                  ...
                                  typeDescriptions: {
                                    typeIdentifier:
                                      "t_struct$_OracleData_$4609_memory_ptr",
                                    typeString:
        ...
        linearizedBaseContracts: [1778, 13135, 7545, 4904, 13196, 63474],
