export declare const IMultiTokenCore: {
    ...
    readonly ast: {
        ...
        readonly nodes: readonly [{
            ...
            readonly linearizedBaseContracts: readonly [12131];
