        ...
        methods: {
          ...
          "supply(address,uint256,address,uint16)": {
            params: {
              ...
              onBehalfOf:
                "The address that will receive the aTokens, same as msg.sender if the user wants to receive them on his own wallet, or a different address if the beneficiary of aTokens is a different wallet",
              referralCode:
          ...
          "withdraw(address,uint256,address)": {
            params: {
              amount:
                "The underlying amount to be withdrawn - Send the value type(uint256).max in order to withdraw the whole aToken balance",
            ...
            members: [
              {
                ...
                typeDescriptions: {
                  typeIdentifier:
                    "t_struct$_ReserveConfigurationMap_$64517_storage_ptr",
              ...
              parameters: [
                {
                  ...
                  typeName: {
                    ...
                    typeDescriptions: {
                      typeIdentifier:
                        "t_struct$_ReserveData_$64549_storage_ptr",
                      typeString: "struct IPool.ReserveData",
                    },
                  },
                  visibility: "internal",
