export const ERC4626Factory = {
    ...
    output: {
      ...
      devdoc: {
        ...
        methods: {
          ...
          "createERC4626(address)": {
            details:
              "Uses CREATE2 deterministic deployment, so there can only be a single vault for each asset. Will revert if a vault has already been deployed for the asset.",
            params: {
              asset: "The base asset used by the vault",
            },
            returns: {
      ...
      userdoc: {
        ...
        methods: {
          "computeERC4626Address(address)": {
            notice:
              "Computes the address of the ERC4626 vault corresponding to an asset. Returns a valid result regardless of whether the vault has already been deployed.",
          },
          "createERC4626(address)": {
  ...
  ast: {
    ...
    id: 64675,
    exportedSymbols: {
      Bytes32AddressLib: [63289],
      ERC20: [63250],
      ERC4626: [62862],
      ERC4626Factory: [64674],
    },
    nodeType: "SourceUnit",
    src: "37:3124:103",
    nodes: [
      ...
      },
      {
        ...
        nodes: [
          ...
          },
          {
            ...
            eventSelector:
              "cbd4e5d1362721c7fd10daaabb1a046344447d4798be55684b8a6b4fc1765d72",
            name: "CreateERC4626",
              ...
              statements: [
                {
                  expression: {
                    ...
                    expression: {
                                ...
                                arguments: [
                                  {
                                    ...
                                    typeDescriptions: {
                                      typeIdentifier:
                                        "t_contract$_ERC4626Factory_$64674",
                      ...
                      typeDescriptions: {
                        typeIdentifier:
                          "t_function_internal_pure$_t_bytes32_$returns$_t_address_$attached_to$_t_bytes32_$",
