export declare const MorphoBlueHyperdriveDeployerCoordinator: {
    abi: readonly [{
    ...
    bytecode: `0x${string}`;
    methodIdentifiers: {
        readonly "convertToBase(address,address,address,address,address,uint256,uint256)": "43dd8fef";
        readonly "convertToShares(address,address,address,address,address,uint256,uint256)": "e71c2aa1";
...
//# sourceMappingURL=MorphoBlueHyperdriveDeployerCoordinator.d.ts.map