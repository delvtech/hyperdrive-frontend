 ...
 * binary search for
 */
export function maxShort(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  budget: string,
  openVaultSharePrice: string,
  checkpointExposure: string,
  maybeConservativePrice?: string,
  maybeMaxIterations?: number,
): string;
/**
 ...
 */
export function spotPriceAfterLong(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  baseAmount: string,
): string;
 ...
 * @param currentTime - The current timestamp (in seconds)
 */
export function calcCloseShort(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
  openVaultSharePrice: string,
 ...
 * @param poolConfig - The pool's configuration
 */
export function idleShareReservesInBase(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
): string;
/**
 ...
 * @param baseAmount - The amount of base tokens to spend
 */
export function openLongGovernanceFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  baseAmount: string,
): string;
 ...
 * @param currentTime - The current timestamp (in seconds)
 */
export function closeLongCurveFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
  maturityTime: string,
 ...
 * @param currentTime - The current timestamp (in seconds)
 */
export function closeLongFlatFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
  maturityTime: string,
 ...
 */
export function openShortCurveFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
): string;
 ...
 * @param bondAmount - The number of bonds to short
 */
export function openShortGovernanceFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
): string;
 ...
 * @param currentTime - The current timestamp (in seconds)
 */
export function closeShortCurveFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
  maturityTime: string,
 ...
 * @param currentTime - The current timestamp (in seconds)
 */
export function closeShortFlatFee(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
  maturityTime: string,
 ...
 * @param bondAmount - The number of bonds to short
 */
export function spotPriceAfterShort(
  poolInfo: JsPoolInfo,
  poolConfig: JsPoolConfig,
  bondAmount: string,
): string;
...
export interface InitOutput {
  ...
  readonly openLongGovernanceFee: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly openShortGovernanceFee: (
    a: number,
    b: number,
    c: number,
    d: number,
...
export const wasmBuffer: ArrayBufferLike;
