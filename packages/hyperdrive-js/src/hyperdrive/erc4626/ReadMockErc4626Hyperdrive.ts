...
export interface ReadMockErc4626HyperdriveMixin {
  getSharesToken(options?: ReadOptions): Promise<ReadMockErc4626>;
}
...
>(Base: T): Constructor<ReadMockErc4626HyperdriveMixin> & T {
  return class extends Base {
    constructor(...[options]: any[]) {
      const { debugName = "Mock ERC-4626 Hyperdrive", ...restOptions } =
    ...
    async getSharesToken(options?: ReadOptions): Promise<ReadMockErc4626> {
