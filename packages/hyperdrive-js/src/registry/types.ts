import { FunctionReturn, Replace } from "@delvtech/drift";
 ...
 * associated with each instance.
 */
export type ReadInstanceInfoWithMetadata = Replace<
...
export type ReadWriteInstanceInfoWithMetadata = Replace<
